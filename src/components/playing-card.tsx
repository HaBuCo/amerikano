...
const styles = StyleSheet.create({
  card: { width: CARD_WIDTH, height: CARD_HEIGHT, borderRadius: 5, backgroundColor: '#fff', overflow: 'hidden', borderWidth: 1, borderColor: '#d2c6ad',
    boxShadow: '0 3px 8px #0005' },
  compact: { width: 37, height: 52, borderRadius: 4 },
  large: { width: 100, height: 140, borderRadius: 8 },
  selected: { transform: [{ translateY: -10 }], borderColor: '#edbf64', borderWidth: 3, boxShadow: '0 0 10px #edbf6480' },
